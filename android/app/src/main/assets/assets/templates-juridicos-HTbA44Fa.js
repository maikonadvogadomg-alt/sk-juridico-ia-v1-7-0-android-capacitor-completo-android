import{c as x,y as b,u as g,r,j as e,g as U}from"./index-CDNpxsZY.js";import{B as t}from"./button-DX0apL_U.js";import{I as M}from"./input-BTIJsSDg.js";import{B as I}from"./badge-C1mt1XBw.js";import{C as L,a as h}from"./card-Cjuca14z.js";import{T as F}from"./textarea-BBPrav7u.js";import{A as B}from"./arrow-left-iAYujk_l.js";import{S as V}from"./scale-DmMbLxmx.js";import{G as j}from"./gavel-sJecG0aB.js";import{B as q}from"./briefcase-CCR6wyKc.js";import{S as G}from"./shield-BQWNtp6q.js";import{B as J}from"./building-2-DWrf5EzT.js";import{B as H}from"./book-open-Clm8Rm5p.js";import{S as X}from"./search-BGnX6OGI.js";import{F as D}from"./file-text-CodgMl_q.js";import{C as w}from"./chevron-right-_PegOHw5.js";import{C as z}from"./copy-DseYTNK0.js";const Z=[["path",{d:"M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5",key:"mvr1a0"}]],$=x("heart",Z),y=U(),k=[{id:"Cível",icon:V,color:"text-blue-400"},{id:"Criminal",icon:j,color:"text-red-400"},{id:"Trabalhista",icon:q,color:"text-yellow-400"},{id:"Família",icon:$,color:"text-pink-400"},{id:"Previdenciário",icon:G,color:"text-green-400"},{id:"Tributário",icon:J,color:"text-purple-400"},{id:"Constitucional",icon:H,color:"text-cyan-400"}],d=[{id:"civ-001",area:"Cível",subtipo:"Petição Inicial",titulo:"Ação de Cobrança",descricao:"Petição inicial para cobrança de dívida com documento comprobatório",variaveis:["AUTOR","CPF_AUTOR","RÉUS","VALOR","COMARCA"],conteudo:`EXCELENTÍSSIMO(A) SENHOR(A) DOUTOR(A) JUIZ(A) DE DIREITO DA VARA CÍVEL DA COMARCA DE {{COMARCA}}
...
_________________________
{{AUTOR_POPULAR}}
CPF: {{CPF}}`}];function Oe(){const[,O]=b(),{toast:n}=g(),[A,R]=r.useState(""),[s,m]=r.useState(null),[o,T]=r.useState(null),[c,E]=r.useState(!1),[i,u]=r.useState(""),p=r.useMemo(()=>d.filter(a=>{const _=!s||a.area===s,l=!A||[a.titulo,a.descricao,a.area,a.subtipo].join(" ").toLowerCase().includes(A.toLowerCase());return _&&l}),[s,A]);function C(a){T(a),u(a.conteudo),E(!1)}function S(){o&&(navigator.clipboard.writeText(i),n({title:"Copiado!",description:"Template copiado para a área de transferência."}))}function v(){o&&(localStorage.setItem("sk-template-para-editor",i),n({title:"Template carregado!",description:"Abrindo o editor com o template..."}),setTimeout(()=>O("/"),800))}async function N(){if(o)try{await fetch(`${y}/doc-templates`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:o.titulo,categoria:o.area,conteudo:i})}),n({title:"Salvo!",description:"Template salvo na sua biblioteca."})}catch{n({title:"Erro",description:"Não foi possível salvar.",variant:"destructive"})}}return e.jsxs("div",{className:"min-h-screen bg-[#0f172a] text-slate-100 flex flex-col",children:[e.jsxs("header",{className:"border-b border-slate-700 px-4 py-3 flex items-center gap-3 bg-[#0f172a]",children:[e.jsx(t,{variant:"ghost",size:"icon",onClick:()=>O("/"),children:e.jsx(B,{className:"h-4 w-4"})}),e.jsxs("div",{children:[e.jsx("h1",{className:"font-bold text-base",children:"Templates Jurídicos"}),e.jsxs("p",{className:"text-xs text-slate-400",children:[d.length," modelos por área do direito"]})]})]}),e.jsxs("div",{className:"flex flex-1 overflow-hidden",children:[e.jsxs("aside",{className:"w-48 border-r border-slate-700 bg-slate-900 flex flex-col py-2 shrink-0",children:[e.jsxs("button",{className:`text-left px-4 py-2 text-sm rounded mx-1 mb-1 transition-colors ${s?"text-slate-300 hover:bg-slate-800":"bg-blue-600 text-white"}`,onClick:()=>m(null),children:["Todas as áreas",e.jsxs("span",{className:"ml-1 text-xs opacity-70",children:["(",d.length,")"]})]}),k.map(({id:a,icon:_,color:l})=>{const P=d.filter(f=>f.area===a).length;return e.jsxs("button",{className:`text-left px-4 py-2 text-sm rounded mx-1 mb-1 flex items-center gap-2 transition-colors ${s===a?"bg-blue-600 text-white":"text-slate-300 hover:bg-slate-800"}`,onClick:()=>m(a),children:[e.jsx(_,{className:`h-3.5 w-3.5 ${s===a?"text-white":l}`}),e.jsx("span",{className:"flex-1",children:a}),e.jsxs("span",{className:"text-xs opacity-60",children:["(",P,")"]})]},a)})]}),e.jsxs("div",{className:"w-64 border-r border-slate-700 bg-slate-900 flex flex-col shrink-0",children:[e.jsx("div",{className:"p-2 border-b border-slate-700",children:e.jsxs("div",{className:"relative",children:[e.jsx(X,{className:"absolute left-2.5 top-2.5 h-3.5 w-3.5 text-slate-500"}),e.jsx(M,{placeholder:"Buscar templates...",value:A,onChange:a=>R(a.target.value),className:"pl-8 h-8 text-xs bg-slate-800 border-slate-600 text-slate-200"})]})}),e.jsxs("div",{className:"flex-1 overflow-y-auto",children:[p.length===0&&e.jsx("p",{className:"text-slate-500 text-xs text-center mt-8",children:"Nenhum template encontrado"}),p.map(a=>e.jsxs("button",{className:`w-full text-left px-3 py-3 border-b border-slate-700/50 hover:bg-slate-800 transition-colors flex items-start gap-2 ${o?.id===a.id?"bg-slate-800 border-l-2 border-l-blue-500":""}`,onClick:()=>C(a),children:[e.jsx(D,{className:"h-4 w-4 text-slate-500 mt-0.5 shrink-0"}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("p",{className:"text-sm font-medium text-slate-200 truncate",children:a.titulo}),e.jsxs("div",{className:"flex items-center gap-1.5 mt-0.5",children:[e.jsx(I,{className:"text-[10px] px-1 py-0 h-4 bg-slate-700 text-slate-400 border-0",children:a.area}),e.jsx("span",{className:"text-[10px] text-slate-500",children:a.subtipo})]}),e.jsx("p",{className:"text-[11px] text-slate-500 mt-1 line-clamp-2",children:a.descricao})]}),e.jsx(w,{className:"h-3 w-3 text-slate-600 mt-1 shrink-0"})]},a.id))]})]}),e.jsx("div",{className:"flex-1 flex flex-col overflow-hidden",children:o?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"border-b border-slate-700 px-4 py-3 bg-slate-900 flex items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"font-semibold text-sm",children:o.titulo}),e.jsxs("div",{className:"flex items-center gap-2 mt-1",children:[e.jsx(I,{className:"text-xs bg-blue-900 text-blue-300 border-0",children:o.area}),e.jsx("span",{className:"text-xs text-slate-400",children:o.subtipo})]}),o.variaveis.length>0&&e.jsxs("p",{className:"text-xs text-slate-500 mt-1",children:["Variáveis: ",o.variaveis.map(a=>`{{${a}}}`).join(", ")]})]}),e.jsxs("div",{className:"flex items-center gap-2 shrink-0",children:[e.jsx(t,{size:"sm",variant:"outline",className:"h-7 text-xs border-slate-600",onClick:()=>E(!c),children:c?"Visualizar":"Editar"}),e.jsxs(t,{size:"sm",variant:"outline",className:"h-7 text-xs border-slate-600",onClick:S,children:[e.jsx(z,{className:"h-3 w-3 mr-1"}),"Copiar"]}),e.jsx(t,{size:"sm",variant:"outline",className:"h-7 text-xs border-slate-600 text-green-400 border-green-700",onClick:N,children:"Salvar na Biblioteca"}),e.jsx(t,{size:"sm",className:"h-7 text-xs bg-blue-600 hover:bg-blue-700",onClick:v,children:"Usar no Editor"})]})]}),e.jsx("div",{className:"flex-1 overflow-auto p-4",children:c?e.jsx(F,{value:i,onChange:a=>u(a.target.value),className:"w-full h-full min-h-[500px] font-mono text-xs bg-slate-800 border-slate-600 text-slate-100 resize-none"}):e.jsx(L,{className:"bg-slate-800 border-slate-700 max-w-3xl mx-auto",children:e.jsx(h,{className:"p-6",children:e.jsx("pre",{className:"text-xs text-slate-200 whitespace-pre-wrap font-sans leading-relaxed",children:i})})})})]}):e.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center gap-4 text-slate-500",children:[e.jsx(D,{className:"h-16 w-16 opacity-20"}),e.jsx("p",{className:"text-sm",children:"Selecione um template para visualizar"}),e.jsxs("p",{className:"text-xs",children:[d.length," modelos prontos para usar"]})]})})]})]})}export{Oe as default};
